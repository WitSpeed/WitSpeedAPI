        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    UpdatedAt = table.Column<DateTime>(nullable: false),
                    TypeName = table.Column<string>(type: "VARCHAR(25)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdPhotoUrl = table.Column<string>(nullable: true),
                    IdPhotoPublicKey = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationLng = table.Column<decimal>(type: "decimal(10, 6)", nullable: false),
                    DestinationAddress = table.Column<string>(nullable: true),
                    DestinationLat = table.Column<decimal>(type: "decimal(10, 6)", nullable: false),
                    DestinationLng = table.Column<decimal>(type: "decimal(10, 6)", nullable: false),
                    TrackingNumber = table.Column<string>(nullable: true),
                    ExpDeliveryDate = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegNumber = table.Column<string>(type: "VARCHAR(25)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DispatchTools", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DispatchTools_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DispatchTools_VehicleTypes_VehicleTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Review_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DispatchTools_DriverId",
                table: "DispatchTools",
                column: "DriverId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DispatchTools_VehicleTypeId",
                table: "DispatchTools",
